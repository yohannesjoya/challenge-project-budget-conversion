...
projectRoutes.post('/budget',
  validateDtoMiddleware(validateCreateBudgetDto), insertBudget)
projectRoutes.put('/budget/:id',
  validateDtoMiddleware(validateUpdateBudgetDto), updateBudget)
